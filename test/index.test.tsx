...
import {ComponentWrapper, HoverAlert, ClickTips, PopAlert, Select, SystemComponent} from '../src/index';
...
render(
    ...
    document.getElementById('__SYSTEM_COMPONENT'));

setTimeout(()=>{
    SystemComponent.open('PopAlert', {
        content: '有动画的-默认组件',
        status: 'error',
    });
}, 1000);
